/**	@brief	Contains the definitions for the baseboard object dictionary.
    ...
    $URL: http://svn/svn/public/trunk/vendor/PulseInnovation/Include/od_vals.h $
    ...
    $LastChangedDate: 2014-08-29 15:18:12 -0400 (Fri, 29 Aug 2014) $

    $LastChangedBy: sclark $
...
#define DEBUG_REV_BC
    ...
    // Turbo mode
    //
    // DESCRIPTION  : Control how much the turbo boosts.  0 = off, 11 = full
    //     (See ctrl.c for why it goes up to 11.)
    // TYPE         : RW
    // RANGE        : 0 - 11
    ENUM_VAL(OD_TURBO_SETTING, 2),
    // DESCRIPTION  : Report whether turbo is engaged right now.
    // TYPE         : RO
    // RANGE        : 0 - 1
    ENUM_VAL(OD_TURBO_ENGAGED, 2),
    ...
    ENUM_CONSTANT(OD_VERSION_VALUE, 7),
